...
uint8_t FrSkySportSensorInav::getRssi() {
  return rssi;
}
float FrSkySportSensorInav::getRxBatt() {
  return rxBatt;
}
float FrSkySportSensorInav::getFuel() {
  return fuel;
}
float FrSkySportSensorInav::getCurrent() {
  return current;
}
float FrSkySportSensorInav::getVoltage() {
  return voltage;
}
float FrSkySportSensorInav::getAltitude() {
  return altitude;
}
float FrSkySportSensorInav::getVario() {
  return vario;
}
int32_t FrSkySportSensorInav::getLat() {
  return inavLat;
}
int32_t FrSkySportSensorInav::getLon() {
  return inavLon;
}
float FrSkySportSensorInav::getSpeed() {
  return speed;
}
float FrSkySportSensorInav::getAccX() {
  return accX;
}
float FrSkySportSensorInav::getAccY() {
  return accY;
}
float FrSkySportSensorInav::getAccZ() {
  return accZ;
}
float FrSkySportSensorInav::getHeading() {
  return heading;
}
int32_t FrSkySportSensorInav::getCapacityUsed() {
  return capUsed;
}
int16_t FrSkySportSensorInav::getFlightMode() {
  return fMode;
}
