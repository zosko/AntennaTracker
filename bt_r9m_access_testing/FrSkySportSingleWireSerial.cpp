...
void FrSkySportSingleWireSerial::begin(SerialId id)
{
  ...
  {
    port = &Serial1;
    Serial1.begin(450000); // Start Serial1 with RX and TX inverted
  ...
  {
    port = &Serial2;
    Serial2.begin(450000); // Start Serial2 with RX and TX inverted
  ...
  {
    port = &Serial3;
    Serial3.begin(450000); // Start Serial3 with RX and TX inverted
